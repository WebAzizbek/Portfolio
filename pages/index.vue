<template>
    <main>
        <div class="hero">
            <a class="rezyume" href="@/assets/img/png/facebook.png" download>Download CV</a>
            <div class="container">
                <div class="img-wrapper">
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" width="100%" id="blobSvg" style="opacity: 1;"><image x="0" y="0" width="100%" height="100%" clip-path="url(#shape)" href="~~/assets/img/jpg/boy.jpg" preserveAspectRatio="none"></image>
                        <defs>
                    ...
                    <clipPath id="shape"><path id="blob" fill="url(#gradient)">
                ...
                <div class="text-wrapper">
                    ...
                    <ul class="list">
                        ...
                        <li class="item">
                            <NuxtLink @mousemove="store.dot = true" @mouseleave="store.dot = false" to="https://t.me/a_akramjonov" class="link">
...
//     let up = e.target.innerText.split('')
...
// onMounted(() => {
//     const textArray = fname.value.getAttribute('data-text').split('');
//     fname.value.innetText = ''
//     textArray.forEach(el => {
//         fname.value.innerHTML += `<span>${el}</span>`;
//         // fname.value.forEach(item => {
//         //     console.log(item);
//         // })
//     })
//     let all = fname.value.children
//     Array.from(all).forEach(item => {
//         item.addEventListener('mouseenter', ()=> {
//             Array.from(all).forEach(elem => {
//                 if(elem !== item) elem.classList.remove('jump')
//             })
